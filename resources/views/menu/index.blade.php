...
@section('our menu')
   ...
   <form enctype="multipart/form-data" method="POST" action="{{url('/menu/add')}}">
                @csrf
				...
				<button type="submite" class="btn btn-outline-success" >Search </button>
				{{--  @if(\Auth::user()->isFullAdmin())  --}}
				
				<a href="{{url('/menu/add')}}"><button type="button" class="btn btn-outline-success" >Add Food</button></a>
				{{--  @endif  --}}
    </form>
