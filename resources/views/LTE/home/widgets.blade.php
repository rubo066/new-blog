      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="{{(Request::segment(1) == '/admin') ? 'active' : ''}}"><a href="{{url('/admin')}}"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a class="{{(Request::segment(1) == '/admin/dashboard') ? 'active' : ''}}"><a href="{{url('/admin/dashboard')}}"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
            {{--  <li><a class="{{(Request::segment(1) == '/admin/dashboard') ? 'active' : ''}}"><a href="{{url('/admin/dashboard')}}"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>  --}}
            <li><a class="{{(Request::segment(1) == '/admin/widgets') ? 'active' : ''}}"><a href="{{url('/admin/widgets')}}"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
